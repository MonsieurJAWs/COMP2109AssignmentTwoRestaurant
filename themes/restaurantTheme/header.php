...
<html lang="<?php language_attributes(); ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo esc_url( home_url('wp-content/themes/restaurantTheme/assets/css/customStyles.css')); ?>">
        ...
        <script src="<?php echo esc_url( home_url('wp-content/themes/restaurantTheme/assets/js/custom-js.js')); ?>"></script>
    </head>
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-dark">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand" href="/home"><img src="<?php echo esc_url( home_url( 'wp-content/uploads/2024/03/ramenLogo.png' ) ); ?>" alt="header logo" height="100" width="100" class="d-inline-block align-top">
                    </a>
