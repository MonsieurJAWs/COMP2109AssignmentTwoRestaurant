<?php
// the navigation bar
function restaurant_setup_theme() {
    // register navigation
...
add_action('init', 'restaurant_food');

// plugin shortcode for custom post type
function restaurant_shortcode() {
...
add_shortcode('food', 'restaurant_shortcode');
